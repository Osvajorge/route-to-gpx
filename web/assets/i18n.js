...
const STRINGS = {
  en: {
    ...
    'map.title': 'Route map',
    'map.hint': 'Drag to look around. Pinch, scroll or use the buttons to zoom. Whole route brings it back.',
    'map.hint.keys': 'Arrows move. Plus and minus zoom. Zero fits the whole route.',
    'map.zoomin': 'Zoom in',
    'map.zoomout': 'Zoom out',
    'map.zoomreset': 'Whole route',
  ...
  es: {
    ...
    'map.hint': 'Arrastra para mirar alrededor. Pellizca, rueda o usa los botones para el zoom. Ruta entera la trae de vuelta.',
    'map.hint.keys': 'Las flechas mueven. Más y menos hacen zoom. Cero encuadra la ruta entera.',
    'map.zoomin': 'Acercar',
    'map.zoomout': 'Alejar',
    'map.zoomreset': 'Ruta entera',
